...
- how to sign in and initialize a workspace
- how to create and manage Automation Accounts
- how to fetch, edit, compare, upload, publish, and delete runbooks
- how to run and debug locally with mocks and isolated modules
- how the protected workspace structure behaves and what can or cannot be moved, renamed, or deleted
